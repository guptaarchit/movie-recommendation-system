...
#rateing:not(:checked) > input {
    position:absolute;
    top:-9999px;
    clip:rect(0,0,0,0);
}

#rateing:not(:checked) > label {
    float:right;
    width:1em;
    padding:0 .1em;
    overflow:hidden;
...
#rateing:not(:checked) > label:before {
    content: '★ ';
}

#rateing > input:checked ~ label {
    color: #f70;
    text-shadow:1px 1px #c60, 2px 2px #940, .1em .1em .2em rgba(0,0,0,.5);
}

#rateing:not(:checked) > label:hover,
...
#rateing > input:checked ~ label:hover,
#rateing > input:checked ~ label:hover ~ label,
#rateing > label:hover ~ input:checked ~ label {
    color: #ea0;
    text-shadow:1px 1px goldenrod, 2px 2px #B57340, .1em .1em .2em rgba(0,0,0,.5);
}

#rateing > label:active {
    position:relative;
    top:2px;
    left:2px;
}
